...
const C = { bg: "#080808", text: "#f0f0f0", red: "#dc2626", muted: "#888", border: "#1a1a1a", card: "#0d0d0d" };
...
export default function ConsentPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: mono }}>
      {/* Nav */}
      <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem 1.5rem", borderBottom: `1px solid rgba(220,38,38,0.2)`, background: "rgba(8,8,8,0.97)" }}>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "3rem 1.25rem 6rem" }}>
        ...
        <div style={{ marginBottom: "3rem" }}>
          <div style={{ fontSize: "0.55rem", letterSpacing: "0.25em", color: C.red, border: `1px solid rgba(220,38,38,0.3)`, padding: "0.25rem 0.7rem", display: "inline-block", marginBottom: "1rem" }}>SMS CONSENT & OPT-IN</div>
