...
const FOCUS_OPTIONS = [
  { emoji: "💪", label: "Going to the gym" },
  { emoji: "📚", label: "Studying / reading" },
  { emoji: "🚀", label: "Building my project" },
  { emoji: "💼", label: "Work tasks" },
  { emoji: "🥗", label: "Eating better" },
...
export default function SetupPage() {
  ...
  const stepTag = (n: string): React.CSSProperties => ({
    fontSize: "0.5rem",
    ...
    <>
      ...
      >
        <div style={{ width: "100%", maxWidth: "480px" }}>
            ...
            {[1, 2, 3, 4].map(s => (
              <div
                ...
                style={{
                  height: "3px",
                  flex: 1,
                  background: s <= step ? "#0ea5e9" : "var(--c-border)",
                  transition: "all 0.3s",
          ...
          {/* ── STEP 4: Success ── */}
          {step === 4 && (
            <div key="step4" style={{ ...slideStyle, textAlign: "center", paddingTop: "1rem" }}>
              <div style={{ fontSize: "4rem", color: "#22c55e", animation: "popIn 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)", display: "inline-block", marginBottom: "1.5rem" }}>
                ✓
              </div>
              <div style={{ fontSize: "2rem", fontWeight: "700", fontFamily: MONO, color: "var(--c-text)", marginBottom: "0.75rem", letterSpacing: "0.1em" }}>
                YOU&apos;RE SET.
              </div>
              <div style={{ fontSize: "0.8rem", color: "var(--c-text3)", marginBottom: "2rem", lineHeight: "1.6" }}>
                Your AI coach is ready. First text incoming soon.
              </div>

              {/* Progress bar */}
              <div style={{ height: "3px", background: "var(--c-border)", width: "100%", overflow: "hidden" }}>
                <div
                  style={{
                    height: "100%",
                    background: "#0ea5e9",
