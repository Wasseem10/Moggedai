    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: mono }}>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "3rem 1.25rem 6rem" }}>
        ...
        <div style={{ marginBottom: "3rem" }}>
          <div style={{ fontSize: "0.55rem", letterSpacing: "0.25em", color: C.red, border: `1px solid rgba(220,38,38,0.3)`, padding: "0.25rem 0.7rem", display: "inline-block", marginBottom: "1rem" }}>FAQ</div>
